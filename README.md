...
### v0.3.3 (2025-10-15)
- **PDF 출력 버그 수정**: 뜻과 예문이 표시되지 않던 문제 해결
- **출력 형식 개선**:
  - 단어/숙어: 뜻 + 활용 예시 (Example) 표시
  - 문장: 유사 표현만 표시
- **meaningDisplay 옵션**: 기본값 'english' 추가로 정의 표시 활성화
- **백엔드 API**: 모든 응답에 examples 배열 포함
